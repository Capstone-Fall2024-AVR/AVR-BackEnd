...
namespace AVR.Infrastructure.Migrations
{
    ...
    [Migration("20241231115442_fix_ProjectsFiles")]
    partial class fix_ProjectsFiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AVR.Domain.Entities.ApartmentOwnerApartment", b =>
                {
                    b.Property<Guid>("ApartmentOwnerApartmentID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("ApartmentOwnerApartmentID");
            ...
            modelBuilder.Entity("AVR.Domain.Entities.ApiLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AVR.Domain.Entities.ApplicationSettings", b =>
                {
                    ...
                    b.Property<int>("DisbursementDurationInMinutes")
                        .HasColumnType("int");

                    b.Property<int>("ExpiryDurationInMinutes")
                        .HasColumnType("int");

                    b.Property<double>("ProcedureFee")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("AVR.Domain.Entities.AppointmentRequest", b =>
                {
                    ...
                    b.Property<string>("AppointmentRequestCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AVR.Domain.Entities.LegalDocument", b =>
                {
            ...
            modelBuilder.Entity("AVR.Domain.Entities.ProjectFile", b =>
                {
                    ...
                    b.Property<int>("ProjectFileTypes")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AVR.Domain.Entities.PropertyRequest", b =>
                {
                    ...
                    b.Property<string>("PropertyRequestCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ProjectApartment", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("LicensingDate")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("AVR.Domain.Entities.ApartmentOwnerApartment", b =>
                {
                    ...
                    b.HasOne("AVR.Domain.Entities.ApartmentOwner", "ApartmentOwner")
                        .WithMany("ApartmentOwnerApartments")
            ...
            modelBuilder.Entity("AVR.Domain.Entities.PropertyVerification", b =>
                {
                    b.HasOne("AVR.Domain.Entities.ApartmentOwnerApartment", "ApartmentOwnerApartment")
                        .WithMany("PropertyVerifications")
                        .HasForeignKey("ApartmentOwnerApartmentID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
