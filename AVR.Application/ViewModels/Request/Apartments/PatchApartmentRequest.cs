...
{
    public class PatchApartmentRequest
    {
        ...
        // Danh sách hình ảnh mới (nếu có)
        public List<IFormFile>? Images { get; set; }

        // Danh sách video VR mới (hỗ trợ upload nhiều file cùng lúc)
        public List<IFormFile>? VRVideoFiles { get; set; }
    }
}
